  ...
  <div class="video-call-container no-select" @mouseenter="showControls" @mouseleave="startHideControlsTimer">
    ...
    <div :class="{ hidden: !controlsVisible }" class="controls">
      <div class="button-group">
        ...
        <button
          id="microphone"
          :class="{ active: !microphoneEnabled, 'with-slash': !microphoneEnabled }"
        ...
        <button
          id="speaker"
          :class="{ active: !speakerEnabled, 'with-slash': !speakerEnabled }"
          class="control-button"
          @click="toggleSpeaker"
        >
        ...
        <button
          id="camera"
          :class="{ active: !cameraEnabled, 'with-slash': !cameraEnabled }"
          class="control-button"
          @click="toggleCamera"
        >
  ...
  .video-call-container {
    ...
    .controls {
      ...
      i {
        ...
        pointer-events: none; /* 确保斜线不会阻断图标交互 */
      }
