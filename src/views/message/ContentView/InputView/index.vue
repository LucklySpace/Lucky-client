<template>
  ...
  >
    ...
    <div class="chat-container-button">
      <button
        :title="settingStore.getShortcut('sendMessage')"
        class="button"
    ...
    <!-- @ 弹窗组件 -->
    <AtDialog
      v-if="atMention.state.visible"
      :position="atMention.state.position"
      :queryString="atMention.state.queryString"
      :users="chatStore.getCurrentGroupMembersExcludeSelf"
      :visible="atMention.state.visible"
      @handleHide="atMention.hideDialog"
