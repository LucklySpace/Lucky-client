...
onMounted(() => {
  globalEventBus.on(Events.CHAT_CHANGED as any, handleChatChanged as any);
  globalEventBus.on(Events.GROUP_NOTICE_CHANGED as any, handleNoticeChanged as any);
});

onBeforeUnmount(() => {
  globalEventBus.off(Events.CHAT_CHANGED as any, handleChatChanged as any);
  globalEventBus.off(Events.GROUP_NOTICE_CHANGED as any, handleNoticeChanged as any);
});
</script>
